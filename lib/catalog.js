...
import { CPU_SPECS, GPU_SPECS, CHIPSET_SPECS, specLine } from "./specs";
...
export const CATS = {
  ...
  cooler: {
    ...
    exclude: /\b(laptop|thermal paste only|case fan pack|GPU cooler|chipset|VRM|fan controller|dust filter)\b/i,
  },
  mobo: {
  ...
  psu: {
    ...
    exclude: /\b(laptop|adapter|UPS|battery backup|surge protector|tester|extension|cable kit|sleeved cable|breakout|bench)\b/i,
  },
  case: {
